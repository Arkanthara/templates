...
\begin{titlepage}
    ...
    $if(university)$
      \includegraphics[width=$if(logosize)$$logosize$$else$0.35\linewidth$endif$]{$if(logo)$$logo$$else$../images/unige.pdf$endif$}\\[0.8cm]
      {\Large\textsc{$university$}}\\
      $if(department)${\large $department$}\\[1.2cm]$endif$
    $else$
      \includegraphics[width=$if(logosize)$$logosize$$else$0.55\linewidth$endif$]{$if(logo)$$logo$$else$../images/unige.pdf$endif$}\\[2cm]
    $endif$
